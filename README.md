...
- 🌐 **Main Site**: [teenoi96.org](https://teenoi96.org/)
- 📱 **Telegram Bot**: [teenoi96.org/bot](https://teenoi96.org/bot/)
- 💻 **Web Application**: [teenoi96.org/app](https://teenoi96.org/app/)
- � **API Documentation**: [teenoi96.org/api/docs](https://teenoi96.org/api/docs)
...
1. **Users**: Visit [app](https://teenoi96.org/app/)
2. **Telegram**: Start bot at [bot](https://teenoi96.org/bot/)
3. **Developers**: Check API docs at [API docs](https://teenoi96.org/api/docs)
...
🔗 **Telegram Bot**: [t.me/DoglcWallet_Bot](https://t.me/DoglcWallet_Bot)
...
Slip verification endpoint `POST /verification/submit-slip` accepts optional field `lang` (one of: `th`, `en`, `zh`, `km`, `ko`, `id`). Response messages adapt to the selected language. OCR extraction currently detects only Thai / English content automatically (basic heuristic) while other languages return English messages unless provided.
